 ...
 * @date 7/19/21
 */
class ApplicationOnLowMemoryMethodVisitor(mv: MethodVisitor) : MethodVisitor(Opcodes.ASM5, mv) {
    ...
    fun callSuper() {
        ...
        mv.visitMethodInsn(
            ...
            CommonConst.METHOD_ON_LOW_MEMORY,
            "()V",
            false
        )
    }
        ...
        fun visitMethodOnNotExist(classVisitor: ClassVisitor) {
            val methodVisitor =
                classVisitor.visitMethod(
                    ...
                    null,
                    null
                ) as? ApplicationOnLowMemoryMethodVisitor
