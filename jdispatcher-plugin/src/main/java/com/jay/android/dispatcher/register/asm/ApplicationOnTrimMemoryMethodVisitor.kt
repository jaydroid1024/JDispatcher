 ...
 * @date 7/19/21
 */
class ApplicationOnTrimMemoryMethodVisitor(mv: MethodVisitor) : MethodVisitor(Opcodes.ASM5, mv) {
    ...
    fun callSuper() {
        ...
        mv.visitMethodInsn(
            ...
            CommonConst.METHOD_ON_TRIM_MEMORY,
            "(I)V",
            false
        )
    }
    ...
    companion object {
        ...
        fun visitMethodOnNotExist(classVisitor: ClassVisitor) {
            val methodVisitor = classVisitor.visitMethod(
                ...
                null,
                null
            ) as? ApplicationOnTrimMemoryMethodVisitor
